...
#' Compare Cobbs-Douglas Models
#' @name cobbs_douglas_models
#' @param ... a list of models generated by the function cobbs_douglas_utility()
#' @returns A dataframe
#' @examples
#' # Compare 4 models
...
#' cobbs_douglas_models(model1, model2, model3, model4_policy)
